...
export const APPROVE_STAKE_TO_PLAY_BUSD = 'APPROVE_STAKE_TO_PLAY_BUSD';
export const TRANSFER_STAKE_TO_PLAY_BUSD = 'TRANSFER_STAKE_TO_PLAY_BUSD';
export const APPROVE_STAKE_TO_TOURNAMENT_BUSD               = 'APPROVE_STAKE_TO_TOURNAMENT_BUSD';
export const APPROVE_STAKE_TO_TOURNAMENT_BUSD_RETURNED      = 'APPROVE_STAKE_TO_TOURNAMENT_BUSD_RETURNED';
export const TRANSFER_STAKE_TO_TOURNAMENTPLAY_BUSD          = 'TRANSFER_STAKE_TO_TOURNAMENTPLAY_BUSD';
export const TRANSFER_STAKE_TO_TOURNAMENTPLAY_BUSD_RETURNED = 'TRANSFER_STAKE_TO_TOURNAMENTPLAY_BUSD_RETURNED';
